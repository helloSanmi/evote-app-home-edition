...
router.put("/candidate/:id", requireAuth, requireAdmin, async (req, res) => {
  try {
    ...
    console.error("admin/candidate/update:", e);
...
router.post("/voting-period", requireAuth, requireAdmin, async (req, res) => {
  try {
    ...
    await notify(io, {
      ...
      scope: electionScope,
      scopeState: electionScope !== "national" ? scopeState || null : null,
      scopeLGA: electionScope === "local" ? scopeLGA || null : null,
      periodId: insertId,
      metadata: {
        periodId: insertId,
        title: title || null,
...
router.put("/voting-period/:id", requireAuth, requireRole(["super-admin"]), async (req, res) => {
  try {
    ...
    console.error("admin/periods/update:", e);
