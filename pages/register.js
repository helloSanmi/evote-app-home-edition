  ...
  return (
    <div className="max-w-md mx-auto px-4">
      <div className="bg-white rounded-2xl shadow p-8 mt-10 transition hover:shadow-lg">
        ...
        <p className="text-center text-gray-600 mb-6">Join <span className="text-blue-700 font-semibold">E-Voting</span> in a minute</p>
        <form onSubmit={submit} className="space-y-4">
          ...
          <div>
            ...
            <input className="border p-3 rounded w-full focus:outline-none focus:ring focus:ring-blue-200"
                   value={username} onChange={(e) => setUsername(e.target.value)} placeholder="janedoe" />
          </div>
          <div>
            <label className="block text-sm text-gray-700 mb-1">Email</label>
            <input type="email" className="border p-3 rounded w-full focus:outline-none focus:ring focus:ring-blue-200"
                   value={email} onChange={(e) => setEmail(e.target.value)} placeholder="jane@mail.com" />
          </div>
          <div>
